<?php
// ./yii message/extract @skeeks/modules/cms/offer/messages/config.php
return [
    // string, required, root directory of all source files
    'sourcePath'   => Yii::getAlias('@skeeks/modules/cms/tracker'),
    ...
    'messagePath'  => Yii::getAlias('@skeeks/modules/cms/tracker/messages'),
